...
Affiliation = u'Sincrotrone Trieste S.C.p.A.'
project = u'STP-Core'
...
MOCK_MODULES = ['numpy', 'numpy.fft', 'h5py', 'pyfftw', 
                'pyfftw.interfaces', 'pyfftw.interfaces.numpy_fft', 
                'pyfftw.interfaces.cache', 'utils', 'utils.padding', 
                'scipy', 'scipy.ndimage', 'scipy.ndimage.filters', 
                'scipy.misc', 'astra', 'tvtomo', '_gridrec',
                'skimage', 'skimage.transform', 'tomopy', 'tifffile',
                'mrfbp', 'mrfbp.ASTRAProjector', 'ringrem', 'pywt',
                'ringrem.rivers', 'ringrem.munchetal', 'ringrem.rave',
                'ringrem.miqueles', '_medfilt']
